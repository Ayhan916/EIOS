...
class TestSoc2ControlModel:
    ...
    def test_unique_constraint(self) -> None:
        ...
        uc_names = {
            c.name
            for c in Soc2ControlModel.__table__.constraints
...
class TestProductionChecklistItemModel:
    def test_tablename(self) -> None:
        from infrastructure.persistence.models.production_checklist import (
    ...
    def test_required_columns(self) -> None:
        ...
        assert {"id", "organization_id", "category", "item_name", "status", "priority"}.issubset(
            cols
        )
