...
EU_TAXONOMY = [
    ...
    FrameworkArticle(
        ...
        esg_categories=("Environmental",),
        keywords=(
            "pollution prevention taxonomy",
            "hazardous substances taxonomy",
            "DNSH pollution",
        ),
    ),
    FrameworkArticle(
    ...
    FrameworkArticle(
        ...
        keywords=(
            ...
            "MSC",
            "OECD guidelines taxonomy",
            "UN guiding principles taxonomy",
        ),
    ),
    FrameworkArticle(
        code="EUTAX-DNSH",
