...
class EvidenceRepository(Protocol):
    async def get_by_id(self, id: str) -> Optional[Evidence]: ...
...
class FindingRepository(Protocol):
    async def get_by_id(self, id: str) -> Optional[Finding]: ...
...
class RiskRepository(Protocol):
    async def get_by_id(self, id: str) -> Optional[Risk]: ...
...
class DecisionRepository(Protocol):
    async def get_by_id(self, id: str) -> Optional[Decision]: ...
...
class ControlRepository(Protocol):
    async def get_by_id(self, id: str) -> Optional[Control]: ...
...
class ProcessRepository(Protocol):
    async def get_by_id(self, id: str) -> Optional[Process]: ...
...
class SectorRepository(Protocol):
    async def get_by_id(self, id: str) -> Optional[Sector]: ...
