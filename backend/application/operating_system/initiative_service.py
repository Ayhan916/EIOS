...
async def list_initiatives(
    ...
    stmt = select(ESGInitiativeModel).where(ESGInitiativeModel.organization_id == organization_id)
...
async def update_initiative(
    ...
    action = (
        ...
        if fields.get("initiative_status") == "COMPLETED"
...
def _to_dict(i) -> dict:
    return {
        ...
        "initiative_status": i.initiative_status,
        "due_date": i.due_date,
        "linked_objectives": i.linked_objectives,
        "linked_suppliers": i.linked_suppliers,
        "linked_findings": i.linked_findings,
