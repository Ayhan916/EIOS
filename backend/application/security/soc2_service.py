...
SOC2_CONTROLS: list[dict[str, str]] = [
    ...
    # CC2 — Communication and Information
    {
        "control_id": "CC2.1",
        "category": "CC2",
        "control_name": "COSO Principle 13 — Relevant quality information",
        "description": "The entity obtains or generates relevant, high-quality information to support internal control.",
    },
    {
        "control_id": "CC2.2",
        "category": "CC2",
        "control_name": "COSO Principle 14 — Internal communication",
        "description": "The entity internally communicates information to support the functioning of internal control.",
    },
    {
        "control_id": "CC2.3",
        "category": "CC2",
        "control_name": "COSO Principle 15 — External communication",
    ...
    # CC3 — Risk Assessment
    {
        "control_id": "CC3.1",
        "category": "CC3",
        "control_name": "COSO Principle 6 — Objectives specification",
    ...
    },
    {
        "control_id": "CC3.3",
        "category": "CC3",
        "control_name": "COSO Principle 8 — Fraud risk",
        "description": "The entity considers the potential for fraud in assessing risks.",
    },
    {
        "control_id": "CC3.4",
        "category": "CC3",
        "control_name": "COSO Principle 9 — Change identification",
    ...
    # CC4 — Monitoring Activities
    {
        "control_id": "CC4.1",
        "category": "CC4",
        "control_name": "COSO Principle 16 — Ongoing and separate evaluations",
        "description": "The entity selects, develops, and performs ongoing and/or separate evaluations.",
    },
    {
        "control_id": "CC4.2",
        "category": "CC4",
        "control_name": "COSO Principle 17 — Evaluation and communication of deficiencies",
    ...
    },
    {
        ...
        "description": "The entity authorizes, modifies, or removes access to data, software, functions, and other resources.",
    },
    {
        "control_id": "CC6.4",
        "category": "CC6",
        "control_name": "Physical access controls",
        "description": "The entity restricts physical access to facilities and protected information assets.",
    },
    {
        "control_id": "CC6.5",
        "category": "CC6",
        "control_name": "Logical and physical protections against threats",
        "description": "The entity discontinues logical and physical protections over physical assets.",
    },
    {
        "control_id": "CC6.6",
        "category": "CC6",
        "control_name": "Security measures against external threats",
        "description": "The entity implements controls to prevent or detect and act upon the introduction of unauthorized software.",
    },
    {
        "control_id": "CC6.7",
        "category": "CC6",
        "control_name": "Transmission and output protection",
        "description": "The entity restricts the transmission, movement, and removal of information to authorized users.",
    },
    {
        "control_id": "CC6.8",
        "category": "CC6",
        "control_name": "Prevention and detection of malicious code",
    ...
    # CC7 — System Operations
    {
        "control_id": "CC7.1",
        "category": "CC7",
        "control_name": "Detection of vulnerabilities",
    ...
    },
    {
        ...
        "description": "The entity evaluates security events to determine whether they could or have resulted in failures.",
    },
    {
        "control_id": "CC7.4",
        "category": "CC7",
        "control_name": "Response to identified security incidents",
        "description": "The entity responds to identified security incidents by executing a defined incident response program.",
    },
    {
        "control_id": "CC7.5",
        "category": "CC7",
        "control_name": "Recovery from identified security incidents",
    ...
    },
    {
        "control_id": "CC9.2",
        "category": "CC9",
        "control_name": "Vendor and business partner risk management",
    ...
    # A1 — Availability
    {
        "control_id": "A1.1",
        "category": "A1",
        "control_name": "Capacity and performance management",
    ...
    },
    {
        ...
        "description": "The entity authorizes, designs, develops, acquires, implements, operates, approves, and monitors environmental protections.",
    },
    {
        "control_id": "A1.3",
        "category": "A1",
        "control_name": "Recovery plan testing",
        "description": "The entity tests recovery plan procedures, including monitoring and evaluating results.",
    },
    # C1 — Confidentiality
    {
        "control_id": "C1.1",
        "category": "C1",
        "control_name": "Identification and maintenance of confidential information",
...
def compute_readiness_score(controls: list[dict[str, Any]]) -> Soc2ReadinessReport:
    ...
    for cat_data in by_cat.values():
        cat_data["pct"] = (
            round((cat_data["implemented"] / cat_data["total"]) * 100, 1)
            if cat_data["total"]
            else 0.0
        )
