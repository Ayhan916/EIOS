...
_FRAMEWORKS: list[dict] = [
    {
        ...
        "requirements": [
            ...
            (
                ...
                "Consolidated sustainability statement under Art. 19a",
            ),
            (
                "CSRD-Art29a",
                "Group Sustainability Statement",
                "Group-level sustainability statement under Art. 29a",
            ),
    ...
    },
    {
        ...
        "requirements": [
            (
                "ESRS-E1",
                "Climate Change",
                "Disclosures on climate change mitigation and adaptation",
            ),
            ("ESRS-E2", "Pollution", "Disclosures on air, water and soil pollution"),
            (
                "ESRS-E3",
                "Water & Marine Resources",
                "Disclosures on water use and marine resources",
            ),
            (
                "ESRS-E4",
                "Biodiversity & Ecosystems",
                "Disclosures on biodiversity and ecosystem services",
            ),
    ...
    },
    {
        ...
        "requirements": [
            ...
            (
                "ISSB-S1-Gov",
                "Governance (S1)",
                "Governance processes for sustainability-related risks and opportunities",
            ),
            (
                "ISSB-S1-Strat",
                "Strategy (S1)",
                "Sustainability-related risks and opportunities and their effects",
            ),
            (
                "ISSB-S1-Risk",
                "Risk Management (S1)",
                "Processes to identify and manage sustainability risks",
            ),
            (
                "ISSB-S1-Metrics",
                "Metrics & Targets (S1)",
            ...
            (
                "ISSB-S2-Strat",
                "Strategy (S2)",
                "Strategy for climate transition and physical risks",
            ),
    ...
    },
    {
        ...
        "requirements": [
            ...
            (
                ...
                "Organizational details, governance, strategy, policies and practices",
            ),
            (
                "GRI-3",
                "Material Topics 2021",
                "Process for determining material topics and managing impacts",
            ),
            (
                "GRI-200",
                "Economic Standards",
            ...
            (
                ...
                "Materials, energy, water, biodiversity, emissions and waste",
            ),
            (
                "GRI-400",
                "Social Standards",
                "Employment, labour practices, human rights, society and product responsibility",
            ),
        ],
    },
    {
        ...
        "requirements": [
            ...
            (
                ...
                "Scope 1, 2 and 3 GHG emissions and targets",
            ),
            (
                "TCFD-METRICS-C",
                "Climate Targets",
                "Targets used to manage climate risks and performance",
            ),
        ],
    },
]
...
def _infer_category(reference: str) -> str:
    ...
    if segments & {"E1", "E2", "E3", "E4", "E5", "300", "S2"} or any(
        x in ref_upper
        for x in ("CLIMATE", "ENVIRON", "WATER", "BIO", "CIRCULAR", "EMISS", "CSRD-E")
    ):
