...
_DEADLINES = [
    ...
    (
        "CSRD",
        "CSRD First-Wave Filing Deadline",
        "2025-03-31",
        "Large public-interest entities (>500 employees) must publish ESRS-compliant sustainability statements for FY2024.",
        "EU",
        "Large",
        True,
        "2024",
    ...
    (
        "CSRD",
        "CSRD Second-Wave Filing Deadline",
        "2026-03-31",
        "Large companies not already covered by wave 1 must file for FY2025.",
        "EU",
        "Large",
        True,
        "2025",
    ...
    (
        "CSRD",
        "CSRD SME Filing Deadline (voluntary)",
        "2027-03-31",
        "Listed SMEs may voluntarily adopt CSRD reporting for FY2026.",
        "EU",
        "SME",
        False,
        "2026",
    ...
    (
        "SFDR",
        "SFDR PAI Annual Report 2024",
        "2024-06-30",
        "Financial market participants must publish annual PAI (Principal Adverse Impact) statements for reference period 2023.",
        "EU",
        "All",
        True,
        "2023",
    ...
    (
        "SFDR",
        "SFDR PAI Annual Report 2025",
        "2025-06-30",
        "PAI statement for reference period 2024.",
        "EU",
        "All",
        True,
        "2024",
    ...
    (
        "SFDR",
        "SFDR PAI Annual Report 2026",
        "2026-06-30",
        "PAI statement for reference period 2025.",
        "EU",
        "All",
        True,
        "2025",
    ...
    (
        "EU_TAXONOMY",
        "EU Taxonomy KPI Disclosure FY2024",
        "2025-04-30",
        "Non-financial reporting entities must disclose EU Taxonomy alignment KPIs (turnover, capex, opex) for FY2024.",
        "EU",
        "Large",
        True,
        "2024",
    ...
    (
        "EU_TAXONOMY",
        "EU Taxonomy KPI Disclosure FY2025",
        "2026-04-30",
        "Taxonomy KPI disclosure for FY2025.",
        "EU",
        "Large",
        True,
        "2025",
    ...
    (
        "TCFD",
        "UK TCFD Mandatory Reporting FY2024",
        "2025-04-30",
        "UK-listed companies and large asset managers must include TCFD-aligned disclosures in annual reports for FY2024.",
        "UK",
        "Large",
        True,
        "2024",
    ...
    (
        "TCFD",
        "UK TCFD Mandatory Reporting FY2025",
        "2026-04-30",
        "UK mandatory TCFD for FY2025.",
        "UK",
        "Large",
        True,
        "2025",
    ...
    (
        "GRI",
        "GRI Annual Report (voluntary)",
        "2025-06-30",
        "Voluntary GRI Standards sustainability report recommended publication date for calendar-year companies.",
        "Global",
        "All",
        False,
        "2024",
    ...
    (
        "SEC_ESG",
        "SEC Climate Disclosure Rule — Large Accelerated Filers",
        "2026-02-28",
        "SEC-registered large accelerated filers must begin climate-related disclosure in 10-K filings for FY2025.",
        "US",
        "Large",
        True,
        "2025",
