...
def upgrade() -> None:
    ...
    op.create_index("ix_cap_org_status", "corrective_action_plans", ["organization_id", "cap_status"])
    op.create_index("ix_cap_org_deadline", "corrective_action_plans", ["organization_id", "deadline"])
