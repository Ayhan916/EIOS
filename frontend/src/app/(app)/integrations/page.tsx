...
const INTEGRATIONS: Integration[] = [
  {
    ...
    category: "ESG",
    icon: CheckCircle2,
    testEndpoint: "/api/v1/integrations/sbti/validate",
    testMethod: "POST",
  },
  {
    id: "cdp",
    ...
    category: "ESG",
    icon: Globe,
    testEndpoint: "/api/v1/integrations/cdp/report",
    testMethod: "POST",
  ...
  },
  {
    ...
    icon: MessageSquare,
    testEndpoint: "/api/v1/integrations/slack/notify",
    testMethod: "POST",
  ...
  },
  {
    ...
    category: "Communication",
    icon: MessageSquare,
    testEndpoint: "/api/v1/integrations/teams/notify",
    testMethod: "POST",
  ...
  },
  {
    ...
    category: "Ticketing",
    icon: Ticket,
    testEndpoint: "/api/v1/integrations/jira/issues",
    testMethod: "GET",
  },
  {
    id: "servicenow",
    ...
    category: "Ticketing",
    icon: Ticket,
    testEndpoint: "/api/v1/integrations/servicenow/incidents",
    testMethod: "GET",
  },
  {
    id: "sharepoint",
    ...
    category: "Storage",
    icon: Link2,
    testEndpoint: "/api/v1/integrations/sharepoint/files",
    testMethod: "GET",
  },
  {
    id: "webhooks",
