  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        >
          <option value="">{t("erp.allSystems")}</option>
        ...
        <select
          ...
          className="rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          <option value="">{t("erp.allStatus2")}</option>
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-dashed border-gray-300 p-12 text-center">
          <p className="text-gray-500">{t("erp.noConnectors")}</p>
          <p className="mt-1 text-sm text-gray-400">
            {t("erp.noConnectorsDesc")}
          </p>
        </div>
      ) : (
          ...
          <table className="min-w-full divide-y divide-gray-200 text-sm">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-medium text-gray-500">{t("erp.lastSync")}</th>
